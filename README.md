...
[CLFF](https://thangckt.github.io/clff/): Automated Frameworks for Concurrent Learning Interatomic Potentials and Material Properties Calculation.

![](https://thangckt.github.io/clff/_assets/image/logo_clff.svg)

CLFF is designed to automatically generate graph-based interactomic potentials through iterative concurrent learning cycles (ML training → MD exploration → DFT labeling). The workflow is fully modular and highly customizable, enabling the entire process to run end-to-end without any user intervention. Key features of clff include:
